## 概要
- **スリープ**: DeepSleepの確認できます。 DeepSleep の時間は３０秒で、起床度ワークカウンタが４０になるまでプログラムが実行される。  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
プログラム実行中にSW2を押すことで、スリープを実行するかしないかを決められます。
- **起動時の状態表示**: 何に起因して起動したかや、例外発生で起動した時の情報をします。
...
3. シリアルモニターにタスク実行ログ、ＡＤＣデータやボタン押下情報などが表示されます。
